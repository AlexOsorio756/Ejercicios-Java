...
public class Conditionals {
    ...
    public static int passOver(int year) {
        int A, B, C, D, E, N;
        A = year % 19;
        B = year % 4;
        C = year % 7;
 ...
 /*
         ...
         * scanner.close();
         */
 /*1.23. La fecha del domingo de Pascua corresponde al primer domingo después de la primera luna llena que sigue al equinoccio de primavera. Dado un año, los cálculos que permiten conocer esta fecha son: 
 • A = año %19 
 • B = año % 4 
 • C = año % 7 
 • D = (19 * A + 24) % 30 
 • E = (2 * B + 4 * C + 6 * D + 5) % 7 
 • N = (22 + D + E) 
 Donde N indica el número del día del mes de marzo (o abril si N es superior a 31) correspondiente al domingo de Pascua. Escribir un programa que lea un año y muestre el día y el mes en el que se celebró o se celebrará el domingo de Pascua ese año. Utilizar una función a la que se le pase como parámetro el año y retorne el valor de N. El programa principal realiza el resto del proceso. */
        ...
        int year = scanner.nextInt();
        int nValue;
        nValue = passOver(year);
        String message = "";
        message = nValue > 31 ? "The year is " + year + " and the month is april" : "The year is " + year + " and the month is march";
